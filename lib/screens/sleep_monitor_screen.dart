// lib/screens/sleep_monitor_screen.dart
import 'dart:async';
...
import 'package:healthapp/widgets/sleep_chart.dart';
import 'package:provider/provider.dart';
import 'package:proximity_sensor/proximity_sensor.dart';
import 'package:sensors_plus/sensors_plus.dart'; // Optional: If you're using Provider
...
class Accelerometer extends State<SleepMonitorScreen> {
  ...
  Future<void> listenSensor() async {
    ...
    FlutterError.onError = (FlutterErrorDetails details, dynamic foundation) {
